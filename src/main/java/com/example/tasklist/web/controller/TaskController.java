...
public class TaskController {
    ...
    @PutMapping
    @Operation(summary = "You can UPDATE the task!")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "You can get taskDto by taskID")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "You can delete task by taskID")
    @PreAuthorize("canAccessTask(#id)")
    ...
    @Operation(summary = "Upload the Image to task")
    @PreAuthorize("canAccessTask(#id)")
